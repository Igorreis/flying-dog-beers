...
def f(tr,c,td,re,Pb,Ef,tc,tf):
        def Corona6(x,t):
                ...
                B1 = Ef*(B1j*Pb/N1)/(1+0.01*np.exp(t-tc)) + (1-Ef)*(B1j*Pb/N1) + Ef*(B1j*Pb/N1)/(1+0.01*np.exp(-t+tf))
                c1 = 1/c
                a1 = (1-0.00001)*a
                mu1 = 0.00001*mu
                k1 = k1j*Pk/N1 
                ...
                B2 = Ef*(B2j*Pb/N2)/(1+0.01*np.exp(t-tc)) + (1-Ef)*(B2j*Pb/N2) + Ef*(B2j*Pb/N2)/(1+0.01*np.exp(-t+tf))
                c2 = 1/c
                a2 = (1-0.002)*a
                mu2 = 0.002*mu
                k2 = k2j*Pk/N2
                ...
                B3 = Ef*(B3j*Pb/N3)/(1+0.01*np.exp(t-tc)) + (1-Ef)*(B3j*Pb/N3) + Ef*(B3j*Pb/N3)/(1+0.01*np.exp(-t+tf))
                c3 = 1/c
                a3 = (1-0.002)*a
                mu3 = 0.002*mu
                k3 = k3j*Pk/N3
                ...
                B4 = Ef*(B4j*Pb/N4)/(1+0.01*np.exp(t-tc)) + (1-Ef)*(B4j*Pb/N4) + Ef*(B4j*Pb/N4)/(1+0.01*np.exp(-t+tf))
                c4 = 1/c
                a4 = (1-0.002)*a
                mu4 = 0.002*mu
                k4 = k4j*Pk/N4 
                ...
                B5 = Ef*(B5j*Pb/N5)/(1+0.01*np.exp(t-tc)) + (1-Ef)*(B5j*Pb/N5) + Ef*(B5j*Pb/N5)/(1+0.01*np.exp(-t+tf))
                c5 = 1/c
                a5 = (1-0.004)*a
                mu5 = 0.004*mu
                k5 = k5j*Pk/N5 
                ...
                B6 = Ef*(B6j*Pb/N6)/(1+0.01*np.exp(t-tc)) + (1-Ef)*(B6j*Pb/N6) + Ef*(B6j*Pb/N6)/(1+0.01*np.exp(-t+tf))
                c6 = 1/c
                a6 = (1-0.013)*a
                mu6 = 0.013*mu
                k6 = k6j*Pk/N6 
                ...
                B7 = Ef*(B7j*Pb/N7)/(1+0.01*np.exp(t-tc)) + (1-Ef)*(B7j*Pb/N7) + Ef*(B7j*Pb/N7)/(1+0.01*np.exp(-t+tf))
                c7 = 1/c
                a7 = (1-0.036)*a
                mu7 = 0.036*mu
                k7 = k7j*Pk/N7 
                ...
                B8 = Ef*(B8j*Pb/N8)/(1+0.01*np.exp(t-tc)) + (1-Ef)*(B8j*Pb/N8)+ Ef*(B8j*Pb/N8)/(1+0.01*np.exp(-t+tf))
                c8 = 1/c
                a8 = (1-0.114)*a
                mu8 = 0.114*mu
                k8 = k8j*Pk/N8 
...
[I,M,CT,t] = f(16,5.2,14,730,0.11,0.5,10,70)
...
@app.callback(
    [Output('slider-output-container-tr', 'children'), Output('slider-output-container-c', 'children'), Output('slider-output-container-td', 'children'), Output('slider-output-container-re', 'children'), Output('slider-output-container-Pb', 'children'), Output('slider-output-container-Ef', 'children'), Output('slider-output-container-tc', 'children'), Output('slider-output-container-tf', 'children'), Output('graph-sim', 'figure')],
...
def update_func_tr(value_1,value_2,value_3,value_4,value_5,value_6,value_7,value_8):
